...
const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          await fetch("/api/clients/add_client", {
            method: "POST",
          ...
          // After successful API call, update the client list
          // You can fetch the updated client list again from the server API
          // and store it in a state variable for rendering in your component.
        } catch (error) {
